...
//broken link is a link which doesn't have any resource in the server, if it is doesn't have any

//resource in the server that will return status code that should be greater than or equal to 400.
